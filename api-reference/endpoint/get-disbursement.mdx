...
api: "GET https://api.checkout.paayoor.com/api/disbursement/{token}"
description: "et endpoint permet de voir les détails d'un déboursement"
---
...
curl --location --request POST 'https://api.checkout.paayoor.com/api/user/{token}' \
